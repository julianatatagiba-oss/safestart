export default function AñadirHijo() {
    return (
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="mb-6">
              ...
              {["Instagram", "YouTube", "TikTok", "Roblox"].map((plataforma) => (                  <label key={plataforma} className="flex items-center gap-2 bg-blue-50 rounded-lg p-3 cursor-pointer hover:bg-blue-100">
